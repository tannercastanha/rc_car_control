...
int map_pulse_to_cmd(uint16_t us)
{
  int val = ((int)us - 1500) / 5;   // roughly -100 to +100
...
int main(void)
{
  ...
  while (1)
  {
    ...
    // Uncomment either of these if directions feel reversed:
     steering = -steering;
     throttle = -throttle;
    ...
    printf("CH1=%u CH2=%u L=%d R=%d\r\n", ch1_us, ch2_us, left_cmd, right_cmd);
    HAL_Delay(20);
